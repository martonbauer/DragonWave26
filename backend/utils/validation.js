...
const SLUG_MAP = [
    ...
    { keys: ['sup', 'női', 'merev', '11km'], slug: 'sup_noi_1_merev_11km' },
    { keys: ['sup', 'férfi', 'merev', '11km'], slug: 'sup_ferfi_1_merev_11km' },
    { keys: ['sup', 'női', 'felfújható', '11km'], slug: 'sup_noi_1_felfujhato_11km' },
    { keys: ['sup', 'férfi', 'felfújható', '11km'], slug: 'sup_ferfi_1_felfujhato_11km' },
